# nomad-api-plugin-test

A test plugin using the API entry point
...
```sh
git clone https://github.com/hampusnasstrom/nomad-api-plugin-test.git
cd nomad-api-plugin-test
